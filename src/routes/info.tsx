...
export default function Info() {
    ...
    return (
        ...
        <div className="text-center font-semibold text-xl mt-1">
            <Button variant="link" onClick={() => window.open("https://github.com/bunkerweb/bunker")}>Github</Button>
            <Button variant="link" onClick={() => window.open("https://bunker-14r.pages.dev/")}>Website</Button>
        </div>
